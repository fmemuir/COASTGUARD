...
#sitename = 'Musselburgh_Planet_DuplicatesTesting_2021present'
sitename = 'Musselburgh_Planet_2020_AdjustDetectionDebug'
lonmin, lonmax = -3.0771538, -3.0475735
latmin, latmax = 55.9444983,55.9505872
...
if len(sat_list) == 1 and sat_list[0] == 'PSScene4Band':
    print('skipping image download - image(s) should be stored locally')
else:
...
clf_model = 'MLPClassifier_Veg_L5L8S2.pkl' # default model (S2)
...
output = Toolbox.RemoveDuplicates(output) # new duplicates function FM Oct2023
